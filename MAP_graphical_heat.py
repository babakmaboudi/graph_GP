...
def MAP_heat():
    ...
    plotter = Graph_Plotter(graph, y_MAP.detach().numpy(), axes[0], pos=pos) # initiating the graph plotter
    ...
    plotter = Graph_Plotter(graph, y_MAP.detach().numpy(), axes[0], pos=pos)
