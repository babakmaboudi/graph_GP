...
def plot_MAP_stationary_linearreaction():
    ...
    # --- Highest 30 true edge weights with posterior uncertainty
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/stationary_linearreaction_top30_edge_hdi.pdf',

        top_k=30,

        hdi_prob=0.95,

        title=r'Highest 30 edge weights: truth, MAP, posterior mean and 95\% HDI',
...
def plot_stationary_linearreaction_real_covid():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/stationary_linearreaction_real_covid_top5_edge_hdi.pdf',

        top_k=5,

        hdi_prob=0.95,

        title=r'Highest 5 inferred edge weights: MAP, posterior mean and 95\% HDI',
...
def plot_MAP_stationary_nonlinearreaction():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/stationary_nonlinearreaction_top30_edge_hdi.pdf',
...
def plot_stationary_nonlinearreaction_real_covid():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/stationary_nonlinearreaction_real_covid_top5_edge_hdi.pdf',
...
def plot_heat_linearreaction():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/heat_linearreaction_top30_edge_hdi.pdf',
...
def plot_heat_nonlinearreaction():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/heat_nonlinearreaction_top30_edge_hdi.pdf',
...
def plot_heat_linearreaction_real_covid():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/heat_linearreaction_real_covid_top5_edge_hdi.pdf',
...
def plot_heat_nonlinearreaction_real_covid():
    ...
    plot_top_edge_hdi(
        ...
        save_path='./plots/heat_nonlinearreaction_real_covid_top5_edge_hdi.pdf',
